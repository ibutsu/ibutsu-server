...
from ibutsu_server.db.base import Model, Column, LargeBinary, Text
...
class ModelMixin(object):
    id = Column(UUID(), primary_key=True, default=_gen_uuid, unique=True, nullable=False)
    data = Column(mutable_json_type(dbtype=JSONB(astext_type=Text), nested=True))
