...
def set_flask_app(app):
    ...
    This function registers the Flask app in the main application registry.
    """
    # Lazy import to avoid circular imports
    import ibutsu_server  # noqa: PLC0415

    ibutsu_server._AppRegistry.flask_app = app
...
def get_flask_app():
    ...
    This function retrieves the Flask app from the main application registry,
    initializing it if necessary.
    """
    # Lazy import to avoid circular imports
    import ibutsu_server  # noqa: PLC0415

    return ibutsu_server._AppRegistry.get_flask_app()
...
class IbutsuTask(Task):
    ...
    def on_failure(self, _exc, task_id, args, _kwargs, _einfo):
        ...
        The @with_app_context decorator ensures this runs in a Flask app context.
        """
        logging.error(f"Task {task_id} failed with args {args}")
