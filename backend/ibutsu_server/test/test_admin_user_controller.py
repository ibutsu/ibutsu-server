...
from ibutsu_server.test import MockProject, MockUser
...
@pytest.fixture
def flask_app_admin():
    """Create Flask app for admin testing"""
    import logging
...
class TestAdminUserController:
    """AdminUserController integration test stubs"""

    def test_admin_get_user_success(self, flask_app_admin, admin_user_controller_mocks):
        """Test case for admin_get_user - successful retrieval"""
        client, jwt_token = flask_app_admin
    ...
    def test_admin_get_user_not_found(self, flask_app_admin, admin_user_controller_mocks):
    ...
    def test_admin_get_user_list_pagination(
        self, flask_app_admin, admin_user_controller_mocks, page, page_size, expected_offset
    ):
    ...
    def test_admin_get_user_list_with_filters(self, flask_app_admin, admin_user_controller_mocks):
    ...
    def test_admin_add_user_success(self, flask_app_admin, admin_user_controller_mocks):
    ...
    def test_admin_add_user_already_exists(self, flask_app_admin, admin_user_controller_mocks):
    ...
    def test_admin_update_user_success(self, flask_app_admin, admin_user_controller_mocks):
    ...
    def test_admin_update_user_not_found(self, flask_app_admin, admin_user_controller_mocks):
    ...
    def test_admin_delete_user_success(self, flask_app_admin, admin_user_controller_mocks):
    ...
    def test_admin_delete_user_not_found(self, flask_app_admin, admin_user_controller_mocks):
    ...
    def test_admin_delete_user_cannot_delete_self(
        self, flask_app_admin, admin_user_controller_mocks
    ):
        ...
        mocks["abort"].assert_called_with(
            HTTPStatus.BAD_REQUEST, description="Cannot delete yourself"
        )

    def test_admin_delete_user_last_superadmin(self, flask_app_admin, admin_user_controller_mocks):
    ...
    def test_admin_delete_user_cleanup_exception(
        self, flask_app_admin, admin_user_controller_mocks
    ):
