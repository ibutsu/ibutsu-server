...
class TestQueryAsTask:
    ...
    def test_query_as_task_small_page_size(self, flask_app):
        ...
        with client.application.app_context():
            ...
            result = get_result_list(page_size=25, page=1)
            assert result == mock_result

    def test_query_as_task_large_page_size(self, flask_app):
        """Test query_as_task dispatches task for large page sizes."""
        from ibutsu_server.util.query import query_as_task
        ...
        with (
            ...
            result, status = get_result_list(page_size=600, page=1)
    ...
    def test_query_as_task_tablename_extraction(self, flask_app):
        ...
        with (
            ...
            # Check the tablename was correctly extracted as "runs"
            call_args = mock_query_task.apply_async.call_args[0][0]
            assert call_args[4] == "runs"  # tablename is 5th argument
...
class TestRedisLock:
    ...
    def test_is_locked_returns_true(self, flask_app):
        ...
        from ibutsu_server.util.redis_lock import is_locked
    ...
    def test_get_redis_client_from_flask_app(self, flask_app):
        ...
        from ibutsu_server.util.redis_lock import get_redis_client
