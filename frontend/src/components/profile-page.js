...
const ProfilePage = () => {
  ...
  const navigation = (
    ...
    <PageSidebar theme={getDarkTheme() ? 'dark' : 'light200'}>
      <PageSidebarBody>
        <Nav
          onSelect={React.Component.onNavSelect}
          theme={getDarkTheme() ? 'dark' : 'light200'}
          aria-label="Nav"
        >
          <NavList>
            <li className="pf-v5-c-nav__item">
              <NavLink to="profile" className="pf-v5-c-nav__link">
                Profile
              </NavLink>
            </li>
            <li className="pf-v5-c-nav__item">
              <NavLink to="tokens" className="pf-v5-c-nav__link">
                Tokens
              </NavLink>
            </li>
          </NavList>
